class Cliente < ActiveRecord::Base
    ...
    attr_accessible :nome_fantasia, :razao_social, :cnpj, :inscricao_municipal, :inscricao_estadual, :cliente_faturamento_id, :cliente_status_id, :user_id, :observacao, :notificacao, :cliente_contatos_attributes, :cliente_enderecos_attributes
