...
$(document).ready(function($) {
  ...
  $(function() {
    ...
    if (typeof cliente_endereco_id != 'undefined') {
      if (cliente_endereco_id == '') {
        $(".endereco_cliente").val('')
      } else {
        $.getJSON("/cliente/enderecos.json", {
          ...
          function(result) {
            ...
            console.log(result);
            $(".endereco_cliente").val(result.rua + " - " + result.numero + " - " + result.complemento + " - " + result.bairro + " - " + result.cidade
              .name + "/" + result.estado.uf + " - " + result.cep);
          });
      };
    };
  });
...
function  GetConfigClientesOP(){
    var cliente_id, prompt ;
